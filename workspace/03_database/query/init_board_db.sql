...
CREATE TABLE member (
    ...
    FOREIGN KEY (recommander_id) REFERENCES member(id) ON DELETE SET NULL
);
...
INSERT INTO member (email, password, name, phone, recommander_id, created_at) VALUES
    ('harong@gmail.com', 'pwd012', '하롱이', '01022223333',1, '2026-01-29 13:34:32'),
    ('yong@gmail.com', 'pwd456', '용쌤', '0103334444',2 , '2026-06-05 14:34:12'),
	('gd@gmail.com', 'pwd456', 'GD쌤', '0103334444',NULL, '2025-03-02 15:00:12');
